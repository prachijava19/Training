...
public class Lambdas {
    ...
    private static void functionalInterface() {
       ...
       System.out.println("Converted to {}"+ stringConverter.convert("100"));
    }
    ...
    private static void methodReference() {
       ...
       System.out.println("Converted to {}"+ intConverter.convert("100"));

        // Referencing instance method
        WordUtil wordUtil = new WordUtil();

        Converter<String, String> firstLetter = wordUtil::firstLetter;
       System.out.println("First letter is {}"+ firstLetter.convert("string"));
    }
    ...
    private static void constructorReference() {
       ...
       System.out.println("Person has name {} {}"+ person.firstName+ person.lastName);
        ...
        for (String element : collection) {
           System.out.println("Collection element is {}"+ element);
        }
    }
    ...
    private void lambdaScope() {
       ...
       System.out.println("Converted to {}"+ stringConverter.convert(3));

        // Implicitly final variable
        int j = 2;
        Converter<Integer, String> implicitConverter = from -> String.valueOf(j + from);
       System.out.println("Converted to {}"+ implicitConverter.convert(3));
       ...
       System.out.println("Converted to {}"+ instanceConverter.convert(3));
       System.out.println("instanceNum is {}"+ instanceNum);
